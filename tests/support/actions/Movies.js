...
export class Movies {
    ...
    async tableHave(content) {
        const rows = this.page.getByRole('row') //achar pela TR no html que pode ser a linha de uma tabela
    ...
    async remove(title){
        await this.page.getByRole('row', {name: title}).getByRole('button').click() //Vai filtrar uma linha/tr da tabela do html com o texto da massa
